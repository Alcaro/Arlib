// This was once part of Arlib, but it has been replaced.
// This file is no longer maintained, and is retained only as a technical curiosity.
...
#define CTREGEX_TYPE(str) (ctregex::mkstr([]{ return "" str ""; }, std::make_index_sequence<sizeof(str)-1>()))
#define CTREGEX(str) (CTREGEX_TYPE(str).parse().compile().optimize())
...
#define CTREGEX_DEBUG_STR(str) (CTREGEX_TYPE(str).fail())
#define CTREGEX_DEBUG_TREE(str) (CTREGEX_TYPE(str).parse().fail())
#define CTREGEX_DEBUG_FLATIN(str) (CTREGEX_TYPE(str).parse().compile().fail())
#define CTREGEX_DEBUG_FLAT(str) (CTREGEX_TYPE(str).parse().compile().optimize().fail())
