...
public:
	...
	//Mappings are invalidated if the file object is deleted.
...
public:
	...
	//Writes to these mappings will be in the file once unmapw() returns, but anything before that is undefined.
	//Writing using multiple functions at once yields undefined results. Having multiple file objects for the same file is also undefined.
