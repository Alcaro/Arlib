...
static inline string tostringhex_dbg(const arrayview<byte>& item)
{
...
static inline string tostringhex_dbg(const arrayvieww<byte>& item) { return tostringhex_dbg((arrayview<byte>)item); }
static inline string tostringhex_dbg(const array<byte>& item) { return tostringhex_dbg((arrayview<byte>)item); }
